          ...
          <?php foreach($params as $question): ?>
            <div id="created-list">
              ...
              <form action="/Users/view.php" method="get" id="user_name">
                <input type="hidden" name="id" value="<?= $question['user_id'] ?>">
                <span>created by </span><input type="submit" value="<?= $question['user_name'] ?>">
              </form>
            </div>
          <?php endforeach; ?>
        </div>
      ...
      <body class="mg_body">
        ...
        <div class="mg_index">
          ...
          <table>
            ...
            <?php foreach($params as $question): ?>
            <tr>
              <td class="mg_index_title"><?= $question['title']; ?></td>
